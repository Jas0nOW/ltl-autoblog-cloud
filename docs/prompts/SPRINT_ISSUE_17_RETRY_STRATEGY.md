...
- Dokumentiert in `docs/make-retry-strategy.md` + Eintrag in `docs/TESTING_LOG.md`.
...
Erstelle `docs/make-retry-strategy.md` als Step-by-step Anleitung (Make UI), inkl:
...
1) Erstelle `docs/SMOKE_TEST_ISSUE_17.md`:
