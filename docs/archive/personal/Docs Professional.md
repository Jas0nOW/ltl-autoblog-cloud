# Copilot Prompt: Profi‑Dokumentation (Scan → Lücken finden → sauber strukturieren)

## Wann benutzen?
- Neues Projekt sauber aufsetzen **oder** bestehendes Repo scannen und Doku „professional-grade“ machen.
- Fokus: **keine Doc-Spam-Orgie**, sondern *eine* klare Struktur + „Single Source of Truth“ pro Thema.

## Modell-Empfehlung (Copilot)
- **Scan/Analyse/Strukturplan:** GPT‑5.2 (oder stärkstes Reasoning)
- **Docs schreiben/umformulieren:** GPT‑4o (oder Haiku/Flash für billige Iterationen)
- **Viele File-Moves/Refactor der Ordnerstruktur:** Claude Sonnet 4.5

> Hintergrund: Unterschiedliche Modelle sind je nach Aufgabe optimiert; GitHub empfiehlt Modellwahl nach Task.
> Doku‑Struktur: Diátaxis (Tutorial/How‑to/Reference/Explanation).

---

## Prompt (1:1 in Copilot Chat einfügen)
